...
__all__ = ['DeepZoomStore', 'upload', 'make_html', 'connect_b2_bucket', 'dzp_save', 'dzi_to_js',
           'list_names_and_js_urls', 'stack_image_json', 'make_multiviewer_jsonp', 'make_multiviewer_html', 'ROOTDIR',
           'VIEWERSDIR']
...
def list_names_and_js_urls(application_key_id, application_key, bucket_name):
    ...
    # list all files in deepzoom bucket folder
    ...
    repl = '\g<name>'
    names = [re.sub(ptrn, repl, f) for f in js_fnames]
...
def make_multiviewer_jsonp(viewer_name, application_key_id, application_key, bucket_name, selection='all'):
    ...
    # not yet implemented a selection possibility

    # connect to bucket and list deep zoom images
